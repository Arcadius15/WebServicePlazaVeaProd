...
public class SecurityConfig extends WebSecurityConfigurerAdapter{
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests()
			...
			//cliente
			.antMatchers(HttpMethod.GET,"/cliente/{id}").hasAnyRole(Roles.ADMIN.name(),Roles.EMPLEADO.name(),Roles.MASTER.name(),Roles.CLIENTE.name(),Roles.DELIVERY.name())
			.antMatchers(HttpMethod.GET,"/cliente").hasAnyRole(Roles.ADMIN.name(),Roles.EMPLEADO.name(),Roles.MASTER.name(),Roles.DELIVERY.name())
			...
			.antMatchers(HttpMethod.PUT,"/historial/{id}").hasAnyRole(Roles.ADMIN.name(),Roles.EMPLEADO.name(),Roles.MASTER.name(),Roles.DELIVERY.name())
			//orden
			.antMatchers(HttpMethod.GET,"/orden/{id}").hasAnyRole(Roles.ADMIN.name(),Roles.EMPLEADO.name(),Roles.MASTER.name(),Roles.CLIENTE.name(),Roles.DELIVERY.name())
			...
			//pedido
			.antMatchers(HttpMethod.GET,"/pedido/{id}").hasAnyRole(Roles.MASTER.name(),Roles.EMPLEADO.name())
			.antMatchers(HttpMethod.GET,"/pedido").hasAnyRole(Roles.MASTER.name(),Roles.EMPLEADO.name())
			.antMatchers(HttpMethod.POST,"/pedido").hasAnyRole(Roles.MASTER.name(),Roles.EMPLEADO.name())
			.antMatchers(HttpMethod.PUT,"/pedido/{id}").hasAnyRole(Roles.MASTER.name(),Roles.EMPLEADO.name())
			//historialpedido
			.antMatchers(HttpMethod.GET,"/historialpedido/{id}").hasAnyRole(Roles.MASTER.name(),Roles.EMPLEADO.name())
			.antMatchers(HttpMethod.GET,"/historialpedido").hasAnyRole(Roles.MASTER.name(),Roles.EMPLEADO.name())
			.antMatchers(HttpMethod.POST,"/historialpedido").hasAnyRole(Roles.MASTER.name(),Roles.EMPLEADO.name())
			.antMatchers(HttpMethod.PUT,"/historialpedido/{id}").hasAnyRole(Roles.MASTER.name(),Roles.EMPLEADO.name())
			.and()
			.httpBasic()
			.and()
			.csrf().disable();
